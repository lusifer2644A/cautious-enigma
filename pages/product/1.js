            ...
            <div className="flex justify-center">
              <div className="flex flex-row flex-wrap gap-8 justify-center py-10 max-w-[1500px]">
                {data.features.map((feat) => {
                  return (
                    <div className="flex flex-col items-center justify-start w-[80%] max-w-[400px] min-h-[500px] px-5 py-10 bg-gradient-to-b from-[#F9E9FF] shadow-lg to-[#F9E9FF] rounded-2xl">
