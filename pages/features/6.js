...
export default function Index() {
  ...
  const data = {
    ...
    heroQues: "Want to manage all your international orders in one platfrom?",
    description:
      "Simplify your order management with our operating system for international ecommerce by leveraging your existing CMS, OMS and WMS into a multi channel sales environment and automate daily operations efficiently.",
    serviceTitle:
    ...
    list: [
      {
        ...
        description:
          "Seamless 2 way integration with your current order, inventory, ERP and warehouse management system",
      },
      {
        id: 2,
        image: "06-02.svg",
        ...
        description:
          "Integrated with global logistic providers and warehousing partners",
      },
      {
        id: 3,
        image: "06-03.svg",
